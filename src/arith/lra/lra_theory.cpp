...
namespace semitone
{
    SEMITONE_EXPORT lra_theory::lra_theory(sat_ptr sat) : theory(std::move(sat)) {}
    SEMITONE_EXPORT lra_theory::lra_theory(sat_ptr sat, const lra_theory &orig) : theory(std::move(sat)), c_bounds(orig.c_bounds), vals(orig.vals), exprs(orig.exprs), s_asrts(orig.s_asrts), layers(orig.layers), listening(orig.listening)
    {
    ...
    SEMITONE_EXPORT lra_theory::~lra_theory()
    {
    ...
    SEMITONE_EXPORT var lra_theory::new_var() noexcept
    {
    ...
    SEMITONE_EXPORT var lra_theory::new_var(const lin &l) noexcept
    ...
    SEMITONE_EXPORT lit lra_theory::new_lt(const lin &left, const lin &right) noexcept
    {
        lin expr = left - right;
        std::vector<var> vars;
    ...
    SEMITONE_EXPORT lit lra_theory::new_leq(const lin &left, const lin &right) noexcept
    {
        lin expr = left - right;
        std::vector<var> vars;
        vars.reserve(expr.vars.size());
    ...
    SEMITONE_EXPORT lit lra_theory::new_geq(const lin &left, const lin &right) noexcept
    {
        lin expr = left - right;
        std::vector<var> vars;
        vars.reserve(expr.vars.size());
    ...
    SEMITONE_EXPORT lit lra_theory::new_gt(const lin &left, const lin &right) noexcept
    {
        lin expr = left - right;
        std::vector<var> vars;
        vars.reserve(expr.vars.size());
