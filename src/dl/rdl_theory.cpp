...
namespace semitone
{
    rdl_theory::rdl_theory(const size_t &size) noexcept : dists(size, std::vector<utils::inf_rational>(size, utils::inf_rational(utils::rational::positive_infinite))), preds(size, std::vector<utils::var>(size))
    {
        assert(size > 1);
    ...
    utils::var rdl_theory::new_var() noexcept
    {
        auto var = n_vars++;
        if (var >= dists.size())
    ...
    utils::lit rdl_theory::new_distance(utils::var from, utils::var to, const utils::inf_rational &dist) noexcept
    {
    ...
    utils::lit rdl_theory::new_distance(utils::var from, utils::var to, const utils::inf_rational &min, const utils::inf_rational &max) noexcept { return get_sat().new_conj({new_distance(to, from, -min), new_distance(from, to, max)}); }
    ...
    void rdl_theory::propagate(utils::var from, utils::var to, const utils::inf_rational &dist) noexcept
    {
    ...
    void rdl_theory::set_dist(utils::var from, utils::var to, const utils::inf_rational &dist) noexcept
    {
    ...
    void rdl_theory::set_pred(utils::var from, utils::var to, utils::var pred) noexcept
    {
