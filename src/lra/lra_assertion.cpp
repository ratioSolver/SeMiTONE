...
namespace semitone
{
    bool lra_leq::propagate_lb(const utils::inf_rational &lb) noexcept
    {
        ...
        if (lb <= v || th.sat->value(b) == utils::False) // nothing to propagate..
            return true;
    ...
    {
        assert(th.cnfl.empty());
        if (ub > v || th.sat->value(b) == utils::True) // nothing to propagate..
            return true;
    ...
    {
        assert(th.cnfl.empty());
        if (lb < v || th.sat->value(b) == utils::True) // nothing to propagate..
            return true;
    ...
    {
        assert(th.cnfl.empty());
        if (ub >= v || th.sat->value(b) == utils::False) // nothing to propagate..
            return true;
